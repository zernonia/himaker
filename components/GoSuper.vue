...
const priceId = computed(() => (isYearly.value ? "price_1LEt2EJvLKxh6TtRJGIpQTGC" : "price_1LEt2EJvLKxh6TtRISqDgCvj"))
  ...
  <Transition name="scale">
    ...
    >
      <div v-if="isOpen" class="w-screen-sm py-24 px-6 flex flex-col items-center bg-white rounded-4xl shadow-xl">
        ...
        <Button :loading="isLoading" class="!mt-4 w-64" :label="buttonLabel" @click="onClick"></Button>
      </div>
    </div>
  </Transition>
</template>
